...
const About: React.FunctionComponent<AboutProps> = () => {
  ...
  return (
    <AboutWrapper>
      <AboutPageTitle>
        <h2>About ETechWeekly</h2>
        <p>
        Gain actionable insights on top trends like security, AI and networking from industry insiders. 
        A must listen for any Enterprise or IT Professional!
        </p>
      </AboutPageTitle>
